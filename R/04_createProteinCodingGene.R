...
#'
#' This function creates a \code{ProteinCodingGene} object, which represents
#' a gene that encodes for proteins. The ProteinCodingGene object includes
#' base information inherited from the \code{Gene} class with the 
#' specific information regarding its protein product.
#' 
...
#' 
#' @return A \code{ProteinCodingGene} object.
#' 
...
#'   two elements: the protein_id and the protein_sequence.
...
#'                   strand = "+")
#'                          
#' gene_product <- list(protein_id = "proteinID", 
#'                       protein_sequence = "MASTATGVFRRAGY")
#' 
#' proteincoding_gene <- createProteinCodingGene(id = "ENST000001",
#'                       hugo_symbol = "SYMBOL1",
...
createProteinCodingGene <- function(id, hugo_symbol, name = NA_character_, 
                                    description = NA_character_, 
                                    tissue_specificity = list(), 
                                    gene_structure, gene_product, 
                                    clinical_significance = NA_character_) {
  new("ProteinCodingGene", id = id, hugo_symbol = hugo_symbol, name = name, 
